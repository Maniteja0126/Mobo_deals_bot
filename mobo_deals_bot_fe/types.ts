...
export interface ChatMessage {
  ...
  text: string;
  timestamp: number;
  relatedProducts?: Product[]; // If the bot recommends products
  relatedOrders?: Order[];   // If the bot finds orders
  isError?: boolean;
}
...
export interface AIResponseSchema {
  ...
  orderQueryId?: string; // If user asks about a specific order ID or "my latest order"
}